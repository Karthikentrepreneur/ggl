...
export const META_CONFIG: Record<string, MetaConfig> = {
  ...
  '/about': {
    ...
    description: 'Discover GGL Australia, a global freight forwarder with over 25 years of experience in international and domestic logistics. We specialize in premium freight forwarding, warehousing, transportation, and end-to-end supply chain solutions—backed by deep industry expertise.',
  ...
  '/services/project-cargo': {
    ...
    description: 'GGL Australia specializes in project cargo logistics, providing tailored solutions for the transport of heavy and oversized equipment. Our services include route surveys, lifting plans, and end-to-end project management to ensure safe and efficient delivery.',
  ...
  '/contact': {
    ...
    description: 'Get in touch with GGL Australia for all your freight and logistics needs. Reach out via our contact form, email, or phone to discuss tailored solutions for your business.',
    keywords: 'GGL Australia, contact GGL Australia, freight solutions, logistics services, supply chain management, customer support, logistics consultation, freight forwarding, international shipping',
  },
  '/privacy-policy': {
